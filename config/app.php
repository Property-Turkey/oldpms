...
return [
     ...
     */
    'debug' => filter_var(env('DEBUG', $isDebug), FILTER_VALIDATE_BOOLEAN),
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '5851393423f9fc6123fbf647ae11bb8f63fde47894932999d871f7d7278c6da8'),
    ],
    ...
    //         'port' => 465,
    //         'timeout' => 300,
    //         'username' => 'noreplay@devzonia.com',
    //         'password' => '--Password--',
    //         'client' => null,
    //         'tls' => false,
    ...
    'Datasources' => [
        ...
        'default' => [
            ...
            'username' => $isLocal ? 'root' : 'propertyturkey',
            'password' => $isLocal ? '' : '--Password--',

            'database' => $isLocal ? 'pms' : 'propertyturkey',
