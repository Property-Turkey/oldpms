        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('user_fullname') ?></th>
                    <th><?= $this->Paginator->sort('email') ?></th>
                    <th><?= $this->Paginator->sort('user_role') ?></th>
                    <th><?= $this->Paginator->sort('user_token') ?></th>
                    <th><?= $this->Paginator->sort('stat_lastlogin') ?></th>
                    <th><?= $this->Paginator->sort('stat_created') ?></th>
                    <th><?= $this->Paginator->sort('stat_logins') ?></th>
                    <th><?= $this->Paginator->sort('stat_ip') ?></th>
